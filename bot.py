...
bot = Bot("svujvwbuwhmdwegisadpwcfnvntsoiwt")
target = "g0BXLgG0ce32cd0b2221c7aa113371ff"
			...
			if msg["type"]=="Text" and not msg.get("message_id") in answered:
				if not sleeped:
					if msg.get("text") == "!فعال" and msg.get("author_object_guid") in admins :
						...
						bot.sendVoice(target, "ممنون به خوبیت تو خوبی؟", message_id=msg.get("message_id"))
...
#دیگو گرام
					...
					elif msg.get("text") == "تست" and msg.get("author_object_guid") :
						hearts = [*"🧡🖤🤍🤎💜💛💚💙❤️"]
						while True: bot.editMessage("target","messageID",choice(hearts))
